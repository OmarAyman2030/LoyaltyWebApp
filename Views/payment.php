...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (isset($_POST['cardname']) && isset($_POST['date']) && isset($_POST['cardnum']) && isset($_POST['cvv'])) {
    $pay->cc($id, $total);
  } elseif (isset($_POST["paypal"])) {
    $pay->pp($id, $total);
  } elseif (isset($_POST["apple-pay"])) {
    $pay->ap($id, $total);
  } elseif (isset($_POST["google-pay"])) {
    $pay->gp($id, $total);
  }
}
?>
...
<body style="overflow-x: hidden;background:#fffae8;">
  <nav class="navbar navbar-expand-lg navbar-light  row d-flex flex-row" style="background: transparent;justify-content: center;">

    <a class="navbar-brand ml-lg-5 ml-md-2 " href="#" style="
        display: flex;
        flex-direction: column;
        justify-content: center;
        align-items: center;
    ">
      <div class="pyramid-loader" style=" margin-bottom: 12px;">
        <div class="wrapper">
      ...
      <h3 class="  d-lg-block text-black-50">Egy Loyality</h3>
    </a>
  </nav>
  <div class="row justify-content-center">
    <div class="col-12 text-center text-black-50 container  " style="margin-top: 0px;">
      <h1>Payment</h1>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-lg-6 mx-auto">
        <div class="custom-div">
          <div class="small-div">Total Price</div>
          <div class="small-div"><?php echo $_SESSION["total_price"] . "$" ?></div>
        </div>
  ...
  <div class="row justify-content-center " style="margin-bottom: 50px;margin-top: 50px;">
    <div class="col-12 text-center text-black-50 container justify-content-center d-flex " style="margin-top: 0px;">
      <div class="new-modal">
        <div class="new-form">
          <div class="new-payment--options">
            <form action="" method="POST">
              <button name="paypal" type="submit" onclick="showSuccessPopup()">
            ...
            <form action="" method="POST">
              <button name="apple-pay" type="submit" onclick="showSuccessPopup()">
            ...
            <form action="" method="POST" method="submit" onclick="showSuccessPopup()">
              <button name="google-pay" type="submit">
          ...
          <form action="" method="POST">
            <div class="new-credit-card-info--form">
              <div class="visa-card">
                ...
                <div class="number-container">
                  ...
                  <input class="inputstyle" id="cardnum" placeholder="XXXX XXXX XXXX XXXX" name="cardnum" type="text" />
                </div>

                <div class="name-date-cvv-container">
                  <div class="name-wrapper">
                    <label class="input-label" for="holderName">CARD HOLDER</label>
                    <input class="inputstyle" name="cardname" placeholder="NAME" type="text" />
                  </div>

                  <div class="expiry-wrapper">
                    <label class="input-label" for="expiry">VALID THRU</label>
                    <input class="inputstyle" id="expiry" placeholder="MM/YY" name="date" type="text" />
                  </div>
                  <div class="cvv-wrapper">
                    <label class="input-label" for="cvv">CVV</label>
                    <input class="inputstyle" placeholder="*" maxlength="3" id="cvv" name="cvv" type="password" />
                  </div>
                </div>
              </div>
            </div>
            <button type="submit" class="new-purchase--btn" onclick="validateAndSubmit()" style=" 
    margin-top: 21px;
    width: 90%;
">Pay</button>
          </form>
  ...
  function showSuccessPopup() {
            var successMessage = "Prayment done successfully!";
