...
$errmsg="";
if(isset($_POST['email'])&&isset($_POST['password'])&&isset($_POST['fname'])&&isset($_POST['lname'])&&isset($_POST['password'])&&isset($_POST['re_password'])&&isset($_POST['phone'])){
$user=new user;
...
if(!$auth->register($user,$_POST['re_password'])){
...
<body style="overflow-x: hidden;background:#fffae8;" >
    <nav class="navbar navbar-expand-lg navbar-light fixed-top row d-flex flex-row" style="background: transparent;justify-content: center;">
    ...
    ">
            ...
            </div><h3 class="  d-lg-block text-black-50">Egy Loyality</h3>
           </a>
      </nav>
      <div class="wrapper55">
...
<?php
          ...
          <div class="input-box">
            <input required="" name="password" placeholder="Password" type="password"><input required=""  name="re_password"  placeholder="Re_Password" type="password">
          </div>
