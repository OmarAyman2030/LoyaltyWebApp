...
$dbController =new Dbcontroller;
 if ($dbController->openconnection()) {
  ...
  $query = "SELECT p.*, pr.donation_p, pr.name, pr.donation_id, d.name AS donation_name FROM payment p JOIN products pr ON p.product_id = pr.id JOIN donation d ON pr.donation_id = d.id WHERE p.user_id = {$_SESSION["userid"]}";
  // Execute the query
