...
// Form Submission Handling for Updating Password
            ...
            <div class="account-settings">
              <div class="user-profile">
                <div class="user-avatar">
                  <img src="images/userp-removebg-preview.png" alt="Maxwell customer">
                </div>
                <h5 class="user-name"><?php echo $_SESSION["username"].$_SESSION["lname"]; ?></h5>
            ...
            <form class="row gutters mb-4" method="post" action="">
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="points" name="points" placeholder="Points" disabled readonly value="<?php echo $_SESSION["points"]; ?>">
                </div>
              </div>

              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="form-group">
                  <label for="eMail">Loyalty ❤</label>
                  <input type="email" class="form-control" id="loyality" name="loyality" placeholder="Enter email ID" disabled="" readonly="" value="<?php if ($_SESSION["loyality"] == 1) echo "silver";
                                                                                                                                                      elseif ($_SESSION["loyality"] == 2) echo "Gold";
                                                                                                                                                      else echo "Platinum" ?>">                </div>
              </div>
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="text-right">
                  <button type="submit" class="btn" style="color: white; background: linear-gradient(0deg, #6d28d9 50%, #d9d9d9 125%);">Update INFO</button>
                </div>
              </div>
            </form>
