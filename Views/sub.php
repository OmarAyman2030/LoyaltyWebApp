...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (isset($_POST['cardname']) && isset($_POST['date']) && isset($_POST['cardnum']) && isset($_POST['cvv'])) {
    $sub->cc($num, $cvv, $name, $date, $id, $total);
    ...
    <div class="row">
      <div class="col-lg-6 mx-auto">
        <div class="custom-div">
          ...
          <div class="small-div">30$ for one year</div>
      ...
      <div class="new-modal">
        <div class="new-form">
          <div class="new-payment--options">
            ...
            <form action="" method="POST">
              <button name="apple-pay" type="submit">
            ...
            <form action="" method="POST" method="submit">
          ...
          <form action="" method="POST">
            ...
            <button type="submit" class="new-purchase--btn" style="
    margin-top: 21px;
    width: 90%;
">Pay</button>
          </form>
