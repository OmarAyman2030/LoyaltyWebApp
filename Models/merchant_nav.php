<nav class="navbar navbar-expand-lg navbar-light  row d-flex flex-row" style= "margin-bottom: 100px;background: linear-gradient(0deg, #6d28d9 50%, #d9d9d9 125%);" >
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto mr-3">
          <li class="nav-item">
  <a class="nav-link text-white textnav" href="merchant.php">Suggest Product</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white textnav" href="view_profit(merchant).php">View Profit</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white textnav" href="view_response(merchant).php">View Resposne's</a>
          </li>
          <li class="nav-item dropdown ">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="view_profile(merchant).php">My profile</a>
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="contactus(mrechant).php">Contact Us&nbsp;
